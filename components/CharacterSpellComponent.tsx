...
const CharacterSpellComponent: React.FC<CharacterSpellComponentProps> = ({ data, characterData, showPreparedSPells }) => {
	...
	if (!showPreparedSPells) {
		return (
			<View style={styles.accordionContainer}>
				...
				{lvlOneData && lvlOneData.length > 0 && <CharacterAccordionComponent title="Level 1" data={lvlOneData} character={characterData} />}
				{lvlTwoData && lvlTwoData.length > 0 && <CharacterAccordionComponent title="Level 2" data={lvlTwoData} character={characterData} />}
				...
				{lvlSixData && lvlSixData.length > 0 && <CharacterAccordionComponent title="Level 6" data={lvlSixData} character={characterData} />}
	...
	return (
		<View style={styles.accordionContainer}>
			{cantripsData && cantripsData.length > 0 && <PreparedSpellsComponent title="Cantrips" data={cantripsData} character={characterData} />}
